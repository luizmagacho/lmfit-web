...
/**
 * Filtros do /catalogo simples: busca + 2 checkboxes, igual à versão de antes do Loop 5 (sem
 * facetas de categoria/tamanho/cor/preço/ordenação — isso fica exclusivo do filtro-rail do /loja).
 */
export function SimpleCatalogFilters() {
